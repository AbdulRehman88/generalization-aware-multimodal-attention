...
JSON_PATH = Path(
    "_research_audit/"
    "bbbd_temporal_matched_16s_metrics_v1.json"
)

CSV_PATH = Path(
    "_research_audit/"
    "bbbd_temporal_matched_16s_metrics_v1.csv"
)


class BBBDTemporalMatchedSixteenSecondResultsAuditTests(
    unittest.TestCase
):
    ...
    def test_sixteen_second_numerical_audit_passed(self) -> None:
        self.assertEqual(
            self.audit["status"],
            "passed",
        )
