# BBBD Manuscript Integration Package V1

Date: 2026-08-03

## Recommended subsection identity

**Independent-Cohort BBBD Experimental-Condition Benchmark**

Do not title this subsection as direct external validation of attention-state
recognition. The BBBD labels represent an experimental attentive-versus-
distracted condition and are confounded with session and task factors.

## Ready-to-paste methods paragraph
...
| Evaluation | Best path | Balanced accuracy [95% CI] | Macro-F1 [95% CI] | ROC-AUC | PR-AUC |
|---|---|---:|---:|---:|---:|
| Experiment 2 to Experiment 3 | EEG | 0.6458 [0.5625, 0.7344] | 0.6222 [0.4992, 0.7265] | 0.6611 | 0.6298 |
| Experiment 3 to Experiment 2 | ECG+EEG+Pupil | 0.6150 [0.5400, 0.7000] | 0.6098 [0.5226, 0.6949] | 0.6238 | 0.5885 |
...
| Evaluation | Path | Balanced accuracy | Macro-F1 | ROC-AUC | PR-AUC | Participant-macro F1 |
|---|---|---:|---:|---:|---:|---:|
| Experiment 2 to Experiment 3 | EEG | 0.6458 | 0.6222 | 0.6611 | 0.6298 | 0.5533 |
| Experiment 2 to Experiment 3 | ECG+EEG+Pupil | 0.6354 | 0.6132 | 0.6552 | 0.6528 | 0.5505 |
| Experiment 2 to Experiment 3 | ECG+EEG | 0.6302 | 0.5997 | 0.6770 | 0.6382 | 0.5321 |
| Experiment 2 to Experiment 3 | EEG+Pupil | 0.5938 | 0.5733 | 0.6866 | 0.6806 | 0.5053 |
| Experiment 2 to Experiment 3 | Pupil | 0.5625 | 0.5152 | 0.7063 | 0.6807 | 0.4476 |
| Experiment 2 to Experiment 3 | ECG+Pupil | 0.5521 | 0.5520 | 0.5611 | 0.5780 | 0.4253 |
| Experiment 2 to Experiment 3 | ECG | 0.5052 | 0.4901 | 0.5188 | 0.5258 | 0.3761 |
| Experiment 3 to Experiment 2 | ECG+EEG+Pupil | 0.6150 | 0.6098 | 0.6238 | 0.5885 | 0.5108 |
| Experiment 3 to Experiment 2 | Pupil | 0.6150 | 0.5998 | 0.6762 | 0.6695 | 0.5210 |
| Experiment 3 to Experiment 2 | EEG | 0.6050 | 0.6045 | 0.6058 | 0.5941 | 0.5330 |
| Experiment 3 to Experiment 2 | ECG+EEG | 0.5700 | 0.5647 | 0.6142 | 0.5703 | 0.4660 |
| Experiment 3 to Experiment 2 | ECG+Pupil | 0.5550 | 0.5313 | 0.5939 | 0.6099 | 0.4481 |
| Experiment 3 to Experiment 2 | EEG+Pupil | 0.5450 | 0.5323 | 0.6176 | 0.6196 | 0.4208 |
| Experiment 3 to Experiment 2 | ECG | 0.4800 | 0.4724 | 0.4900 | 0.5120 | 0.3570 |
...
- leakage-safe classification of the experimentally defined condition;
- participant-disjoint within-experiment evaluation;
- independent-cohort transfer under experiment and cohort shift;
- aligned comparison of seven modality paths;
- moderate EEG and multimodal predictive signal.

Unsupported claims:

- isolated or causal measurement of attention;
- unconfounded attention-state recognition;
- universal superiority of trimodal fusion;
- matched-stimulus external validation;
- deployment effectiveness.

## Windowing statement

The primary BBBD analysis used four-second windows with 50% overlap, yielding a
two-second stride, after trimming two seconds from each recording edge. This
setting was locked before performance observation. A future zero-overlap run
may only be presented as a post-primary sensitivity analysis.

The 51,831 windows are not 51,831 statistically independent observations.
Recordings are the primary reporting unit, and participants are the uncertainty
and resampling unit.
