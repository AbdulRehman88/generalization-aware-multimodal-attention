"""Independent numerical audit of matched BBBD eight-second reports."""
...
EXPECTED_MANIFEST_IDENTITY = (
    "bbbd_temporal_matched_08s_reports_v1"
)
...
def audit_eight_second_reports(
    ...
    payload.update(
        {
            "audit_identity":
                "bbbd_temporal_matched_08s_metrics_v1",
            "source_commit":
                "cbdddce",
            "status":
                "passed",
            ...
            "temporal_interpretation_boundary":
                (
                    "Eight seconds is a prespecified post-primary "
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Independently audit matched BBBD eight-second reports."
        )
    )
    ...
    payload, metrics = audit_eight_second_reports(
    ...
    print(
        "\n===== EIGHT-SECOND NUMERICAL AUDIT SUMMARY ====="
    )
    ...
    print(
        "\nINDEPENDENT 8-SECOND NUMERICAL AUDIT PASSED"
    )
